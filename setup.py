...
setup(
    ...
    version = 'v0.4.12',  # Ideally should be same as your GitHub release tag varsion
    ...
    download_url = 'https://github.com/tekktrik/parallel64/archive/refs/tags/v0.4.12.tar.gz',
