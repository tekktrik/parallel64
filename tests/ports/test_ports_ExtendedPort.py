...
def test_ExtendedPort_init():
    try:
        _ = parallel64.ports.ExtendedPort(0x378, 0x778)
    except:
        assert False


def test_ExtendedPort_write_ecp_ecr():
    port = parallel64.ports.ExtendedPort(0x378, 0x778)
...
def test_ExtendedPort_ecp_data_address():
    base_ecp_address = 0x778
    port = parallel64.ports.ExtendedPort(0x378, base_ecp_address)
